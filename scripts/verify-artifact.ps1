...
$destination = Join-Path $projectRoot 'dist\MyJournal-1.0.2.apk'
...
if ($manifest -notmatch "package: name='com.nsfr.myjournal' versionCode='3' versionName='1\.0\.2'") { throw 'Неверный package или версия APK' }
...
$report = [ordered]@{
    ...
    deviceTests = 'Not run for 1.0.2 (host-only verification requested)'
